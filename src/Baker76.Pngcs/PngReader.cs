...
namespace Baker76.Pngcs
{
    ...
    public class PngReader
    {
        ...
        public PngReader(Stream inputStream, String filename)
        {
            ...
            this.ChunkLoadBehaviour = Baker76.Pngcs.Chunks.ChunkLoadBehaviour.LOAD_CHUNK_ALWAYS;
        ...
        private void UnfilterRow(int nbytes)
        {
            ...
            switch (ft)
            {
                case Baker76.Pngcs.FilterType.FILTER_NONE:
                    UnfilterRowNone(nbytes);
                    break;
                case Baker76.Pngcs.FilterType.FILTER_SUB:
                    UnfilterRowSub(nbytes);
                    break;
                case Baker76.Pngcs.FilterType.FILTER_UP:
                    UnfilterRowUp(nbytes);
                    break;
                case Baker76.Pngcs.FilterType.FILTER_AVERAGE:
                    UnfilterRowAverage(nbytes);
                    break;
                case Baker76.Pngcs.FilterType.FILTER_PAETH:
        ...
        private void ReadFirstChunks()
        {
            ...
            while (!found)
            {
                ...
                PngHelperInternal.ReadBytes(inputStream, chunkid, 0, 4);
                offset += 4;
                if (PngCsUtils.arraysEqual4(chunkid, Baker76.Pngcs.Chunks.ChunkHelper.b_IDAT))
                {
                    found = true;
                ...
                else if (PngCsUtils.arraysEqual4(chunkid, Baker76.Pngcs.Chunks.ChunkHelper.b_IEND))
                {
