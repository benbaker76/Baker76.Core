...
namespace Baker76.Pngcs.Chunks
{
    ...
    public class PngChunkPHYS : PngChunkSingle
    {
        ...
        public override ChunkRaw CreateRawChunk()
        {
            ...
            Baker76.Pngcs.PngHelperInternal.WriteInt4tobytes((int)PixelsxUnitX, c.Data, 0);
            Baker76.Pngcs.PngHelperInternal.WriteInt4tobytes((int)PixelsxUnitY, c.Data, 4);
            c.Data[8] = (byte)Units;
            return c;
        }
        ...
        public override void ParseFromRaw(ChunkRaw chunk)
        {
            ...
            PixelsxUnitX = Baker76.Pngcs.PngHelperInternal.ReadInt4fromBytes(chunk.Data, 0);
            if (PixelsxUnitX < 0)
                PixelsxUnitX += 0x100000000L;
            PixelsxUnitY = Baker76.Pngcs.PngHelperInternal.ReadInt4fromBytes(chunk.Data, 4);
            if (PixelsxUnitY < 0)
                PixelsxUnitY += 0x100000000L;
            Units = Baker76.Pngcs.PngHelperInternal.ReadInt1fromByte(chunk.Data, 8);
        }
