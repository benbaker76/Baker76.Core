...
namespace Baker76.Pngcs.Chunks
{
    ...
    public class ChunkHelper
    {
        ...
        {
            return Baker76.Pngcs.PngHelperInternal.charsetLatin1.GetBytes(x);
        }
        ...
        {
            return Baker76.Pngcs.PngHelperInternal.charsetLatin1.GetString(x);
        }
        /// <summary>
        ///  Converts to String using Latin1 (ISO-8859-1)
        /// </summary>
        ...
        {
            return Baker76.Pngcs.PngHelperInternal.charsetLatin1.GetString(x, offset, len);
        }
        ...
        {
            return Baker76.Pngcs.PngHelperInternal.charsetUtf8.GetBytes(x);
        }
        ...
        {
            return Baker76.Pngcs.PngHelperInternal.charsetUtf8.GetString(x);
        }
        /// <summary>
        /// Converts to string using UTF-8
        /// </summary>
        ...
        {
            return Baker76.Pngcs.PngHelperInternal.charsetUtf8.GetString(x, offset, len);
        }
        /// <summary>
