...
namespace Baker76.Pngcs.Chunks
{
    ...
    public class PngChunkICCP : PngChunkSingle
    {
        ...
        public override ChunkRaw CreateRawChunk()
        {
            ...
            System.Array.Copy((Array)(Baker76.Pngcs.Chunks.ChunkHelper.ToBytes(profileName)), 0, (Array)(c.Data), 0, profileName.Length);
        ...
        {
            int pos0 = Baker76.Pngcs.Chunks.ChunkHelper.PosNullByte(chunk.Data);
            profileName = Baker76.Pngcs.PngHelperInternal.charsetLatin1.GetString(chunk.Data, 0, pos0);
