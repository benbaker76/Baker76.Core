    ...
    public class PngChunkTRNS : PngChunkSingle
    {
        ...
        public override ChunkRaw CreateRawChunk()
        {
            ...
            if (ImgInfo.Greyscale)
            {
                ...
                Baker76.Pngcs.PngHelperInternal.WriteInt2tobytes(gray, c.Data, 0);
            }
            ...
            else
            {
                ...
                Baker76.Pngcs.PngHelperInternal.WriteInt2tobytes(red, c.Data, 0);
                Baker76.Pngcs.PngHelperInternal.WriteInt2tobytes(green, c.Data, 0);
                Baker76.Pngcs.PngHelperInternal.WriteInt2tobytes(blue, c.Data, 0);
            }
            return c;
        }
        ...
        public override void ParseFromRaw(ChunkRaw c)
        {
            if (ImgInfo.Greyscale)
            {
                gray = Baker76.Pngcs.PngHelperInternal.ReadInt2fromBytes(c.Data, 0);
            }
            else if (ImgInfo.Indexed)
            {
            ...
            {
                red = Baker76.Pngcs.PngHelperInternal.ReadInt2fromBytes(c.Data, 0);
                green = Baker76.Pngcs.PngHelperInternal.ReadInt2fromBytes(c.Data, 2);
                blue = Baker76.Pngcs.PngHelperInternal.ReadInt2fromBytes(c.Data, 4);
            }
        }
