...
namespace Baker76.Pngcs.Chunks
{
    ...
    public class PngChunkTIME : PngChunkSingle
    {
        ...
        public override ChunkRaw CreateRawChunk()
        {
            ...
            Baker76.Pngcs.PngHelperInternal.WriteInt2tobytes(year, c.Data, 0);
            c.Data[2] = (byte)mon;
            c.Data[3] = (byte)day;
            c.Data[4] = (byte)hour;
            c.Data[5] = (byte)min;
        ...
        public override void ParseFromRaw(ChunkRaw chunk)
        {
            ...
            year = Baker76.Pngcs.PngHelperInternal.ReadInt2fromBytes(chunk.Data, 0);
            mon = Baker76.Pngcs.PngHelperInternal.ReadInt1fromByte(chunk.Data, 2);
            day = Baker76.Pngcs.PngHelperInternal.ReadInt1fromByte(chunk.Data, 3);
            hour = Baker76.Pngcs.PngHelperInternal.ReadInt1fromByte(chunk.Data, 4);
            min = Baker76.Pngcs.PngHelperInternal.ReadInt1fromByte(chunk.Data, 5);
            sec = Baker76.Pngcs.PngHelperInternal.ReadInt1fromByte(chunk.Data, 6);
        }
