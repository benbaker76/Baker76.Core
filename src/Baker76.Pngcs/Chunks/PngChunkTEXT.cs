...
namespace Baker76.Pngcs.Chunks
{
    ...
    public class PngChunkTEXT : PngChunkTextVar
    {
        ...
        public override ChunkRaw CreateRawChunk()
        {
            ...
            byte[] b1 = Baker76.Pngcs.PngHelperInternal.charsetLatin1.GetBytes(key);
            byte[] b2 = Baker76.Pngcs.PngHelperInternal.charsetLatin1.GetBytes(val);
        ...
        public override void ParseFromRaw(ChunkRaw c)
        {
            ...
            for (i = 0; i < c.Data.Length; i++)
                if (c.Data[i] == 0)
                    break;
            key = Baker76.Pngcs.PngHelperInternal.charsetLatin1.GetString(c.Data, 0, i);
            i++;
            val = i < c.Data.Length ? Baker76.Pngcs.PngHelperInternal.charsetLatin1.GetString(c.Data, i, c.Data.Length - i) : "";
        }
